...
export class Backend implements backendInterface {
    ...
    async addNearbyDevice(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addNearbyDevice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addTransferRecord(arg0: string, arg1: string, arg2: bigint, arg3: Variant_completed_failed): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addTransferRecord(arg0, arg1, arg2, to_candid_variant_n8(this._uploadFile, this._downloadFile, arg3));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async connectToDevice(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.connectToDevice(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteFile(arg0: ExternalBlob): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteFile(await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getFileById(arg0: ExternalBlob): Promise<FileMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.getFileById(await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg0));
                return from_candid_FileMetadata_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async getNearbyDevices(): Promise<Array<Device>> {
        if (this.processError) {
            try {
                const result = await this.actor.getNearbyDevices();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async uploadFile(arg0: string, arg1: bigint, arg2: string, arg3: ExternalBlob): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.uploadFile(arg0, arg1, arg2, await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg3));
...
function from_candid_TransferRecord_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _TransferRecord): TransferRecord {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.id),
        fileName: value.fileName,
        fileSize: value.fileSize,
        fileType: value.fileType,
        blobId: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.blobId),
...
function from_candid_variant_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    failed: null;
}): Variant_completed_failed {
    return "completed" in value ? Variant_completed_failed.completed : "failed" in value ? Variant_completed_failed.failed : value;
}
...
function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_TransferRecord>): Array<TransferRecord> {
    return value.map((x)=>from_candid_TransferRecord_n19(_uploadFile, _downloadFile, x));
}
...
function to_candid_variant_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Variant_completed_failed): {
    completed: null;
} | {
    failed: null;
} {
